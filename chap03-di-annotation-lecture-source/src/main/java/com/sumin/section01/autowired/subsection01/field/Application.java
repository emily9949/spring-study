package com.sumin.section01.autowired.subsection01.field;
...
public class Application {
    public static void main(String[] args) {
        ...
        /* 설명. ComponentScan 개념의 basePackage 문자열을 넣으면 따로 설정 파일 없이
        *   ComponentScan이 적용됨
        * */
        ApplicationContext context = new AnnotationConfigApplicationContext("com.sumin.section01");
