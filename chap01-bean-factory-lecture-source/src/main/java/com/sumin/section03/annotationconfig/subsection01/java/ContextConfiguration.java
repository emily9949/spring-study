package com.sumin.section03.annotationconfig.subsection01.java;

import com.sumin.common.MemberDAO;
import org.springframework.context.annotation.ComponentScan;
import org.springframework.context.annotation.Configuration;
import org.springframework.context.annotation.FilterType;

/* 설명.
*   section03에서는 ComponentScan과 관련하여 java 클래스에서 @ComponentScan 범위를
*   bean으로 등록하는 방법을 다룬다 (실제 bean으로 등록할 때 자주 쓰이는 어노테이션)
*  */
@Configuration
...
@ComponentScan(basePackages = "com.sumin",
        excludeFilters = {
...
@ComponentScan(basePackages = {"com.sumin", "com"},
